...
describe("assurance Pages publication", () => {
	it("publishes one canonical main page when an owning source changes", () => {
		...
		for (const path of ["AGENTS.md", "ci/assurance-explorer.ts", "ci/assurance-graph.ts", "ci/assurance-observations.ts", "ci/assurance-views.ts", "docs/assurance/**", "docs/decisions/**", "docs/trust/**", "package.json", "pnpm-lock.yaml"]) {
