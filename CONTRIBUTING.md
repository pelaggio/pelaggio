...
or later** (`AGPL-3.0-or-later`) — see [`LICENSE`](./LICENSE). By contributing, you
agree that your contributions are licensed under the same terms (inbound = outbound).
...
project's license. It is a lightweight alternative to a CLA.
