...
const AUTONOMY_APPEND = [
	...
	"If you genuinely cannot complete the step, make the final line of your reply exactly `BLOCKED: <kind> | <reason>` with nothing after it, instead of asking a question or offering options. `<kind>` is one of `spec-defect`, `prerequisite`, `capability`, `environment`, `charter-defect`. Completing the step normally needs no sentinel.",
