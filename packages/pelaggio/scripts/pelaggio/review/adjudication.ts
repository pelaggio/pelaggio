...
export function selectLatestFleetGateRecord(records: readonly PrReviewGateRecord[], prNumber: number): PrReviewGateRecord | undefined {
	...
	fleet.sort((a, b) => {
		...
		return a.headSha < b.headSha ? -1 : a.headSha > b.headSha ? 1 : 0;
	});
	return fleet[0];
}
