...
const illustratedOg = join(publicDir, "og.jpg");
if (!existsSync(illustratedOg)) {
	throw new Error("public/og.jpg is required for the social card");
}
console.log("gen-icons: keeping illustrated og.jpg");
