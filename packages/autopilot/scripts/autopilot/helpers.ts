...
export type PickReason = "claimed" | "blocked" | "unknown-id" | "already-done" | "already-claimed" | "worktree-exists" | "queue-empty";

const PICK_REASONS: ReadonlySet<PickReason> = new Set(["claimed", "blocked", "unknown-id", "already-done", "already-claimed", "worktree-exists", "queue-empty"]);
