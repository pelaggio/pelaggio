...
- `docs/agent-context/contained-execution.md`: (design) two-primitive confinement for agent steps — a host-side auth-terminating egress broker (the agent never holds a reusable credential; #176) + an FS/exec-confinement container; decouples #214's native-status vs subscription-cost goals; folds in #240/#237.
