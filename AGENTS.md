...
- `docs/agent-context/contained-execution.md`: (design) provider-agnostic containerized execution boundary for agent steps — the FS/network/cred/env contract, and how #214 (review→native merges), authoring cycles, #240, and #176 fold into it.
