...
- `docs/agent-context/local-autopilot.md`: (design → ADR-0029) local-autopilot contract v0 — Run as the public durable object, WorkContract input, journal-authoritative recovery, effects denied by default, `ready_for_review` as success; CLI projections over start/get/continue/cancel.
