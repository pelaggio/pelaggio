...
| **G** — self-contained source provenance without transcript storage | [P3](./p3-lineage-provenance.md) | provenance answers require mutable joins, or degenerate into transcripts | **7 of 13 answers not durable** — 2 mutable-join, 5 unanswerable on #481 (3 and 4 on #483). The charter itself (G's own first question) lives in an editable issue body. Transcript signal did **not** fire | **Falsified** | G needs a *capture-at-the-boundary* obligation, not just a schema. Do not weaken the definition to match |
