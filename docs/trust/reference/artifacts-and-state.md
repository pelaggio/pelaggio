...
| Worktrees | Sibling worktree paths chosen by roadmap adapter/prefix | Item branch checkout, edits, test output, local diffs. | Remove after preserving needed work. Hard confinement planned. | `TC-011`, `TC-015` |
